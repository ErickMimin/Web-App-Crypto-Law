...
from .codigoAparte.almacenaBase import almacenaCaso, obtenObjectCaso, almacenaAbogado, almacenaRelacion
...
def cifrarCaso( request ):
    ...
    if request.method == "POST":
        ...
        users = separateKey( key, numeroN, numeroK, nombreCaso, nameUserList, chatID, url )
